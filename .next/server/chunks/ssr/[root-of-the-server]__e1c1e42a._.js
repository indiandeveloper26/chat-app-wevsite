...
function SignupPage() {
    ...
    const handleSignup = async ()=>{
        ...
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$apicall$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post('/singup', {
            ...
            router.push("componenet/chatlist"); // Next.js page navigation
        } catch (error) {
            console.error(error);
