...
function SignupPage() {
    ...
    const handleSignup = async ()=>{
        ...
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post("http://localhost:5000/signup", {
            ...
            if (apiRes.user?.premiumExpiry) localStorage.setItem("premiumExpiry", apiRes.user.premiumExpiry);
            if (apiRes.user?.isPremium !== undefined) localStorage.setItem("isPremium", apiRes.user.isPremium.toString());
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a9d64130._.js.map