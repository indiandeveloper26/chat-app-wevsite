...
"[project]/app/postshow/[...postuserprifile]/page.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function UserProfile() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "UserProfile.useEffect": ()=>{
            if (!id) return;
            const fetchData = {
                "UserProfile.useEffect.fetchData": async ()=>{
                    try {
                        const res = await api.get("/user/".concat(id)); // backend se data fetch
            ...
            }["UserProfile.useEffect.fetchData"];
            fetchData();
        }
    }["UserProfile.useEffect"], [
        id
...
_s(UserProfile, "EkpiDb7cQ8ODd5CmN/dZEs8g2xQ=", false, function() {
    return [
...
//# sourceMappingURL=_96722229._.js.map