...
function UserProfile() {
    ...
    const { id } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$router$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"])();
        ...
        "UserProfile.useEffect": ()=>{
            ...
            const fetchData = {
                "UserProfile.useEffect.fetchData": async ()=>{
                    try {
                        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$apicall$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get("/user/".concat(id)); // backend se data fetch
...
_s(UserProfile, "2ZBccHMugwajxRU19hggUVQNqsU=", false, function() {
    return [
...
//# sourceMappingURL=app_2fbcb924._.js.map